<template>
  <div class="container my-5">
    <h1 class="text-center">Privacy Policy for Survival Odyssey</h1>
    <p class="text-muted text-center">Last updated: June 18, 2024</p>
    ...
    <ul>
      ...
      <li>
        ...
        "Us" or "Our" in this Agreement) refers to ФОП Зозуля Вячеслав Олегович,
        Bezludivka, Zmievskaya Street, 122.
      </li>
      <li>
      ...
      <li>
        <strong>Website</strong> refers to Survival Odyssey, accessible from
        g2c-games.com
      </li>
      <li>
    ...
    <ul>
      ...
      <li><strong>Administered by:</strong> Us</li>
      <li>
        <strong>Purpose:</strong> These Cookies identify if users have accepted
    ...
    <ul>
      <li>By email: g2c.survivalodyssey@gmail.com</li>
      <li>
        By visiting this page on our website:
        <a href="https://g2c-games.com/contact"
          >https://g2c-games.com/contact</a
        >
      </li>
    </ul>
  </div>
